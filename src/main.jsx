...
const inferDbStoryFieldSupport = (items) => {
    ...
    return {
        ...
        facebookVideoUrl: first ? Object.prototype.hasOwnProperty.call(first, "facebook_video_url") : null,
        instagramVideoUrl: first ? Object.prototype.hasOwnProperty.call(first, "instagram_video_url") : null,
        youtubeVideoUrl: first ? Object.prototype.hasOwnProperty.call(first, "youtube_video_url") : null,
    };
};
                            ...
                            >
                                ...
                                <a
                                    ...
                                    style={{
                                        ...
                                        background: "linear-gradient(180deg, rgba(255,241,247,0.98), rgba(255,248,252,0.96))",
                                    }}
                                >
                                    <span aria-hidden="true" style={{ display: "inline-flex", alignItems: "center", justifyContent: "center" }}>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="url(#ig-grad)" aria-hidden="true">
                                            <defs>
                                    ...
                                    <span style={{ display: "grid", gap: "2px", minWidth: 0 }}>
                                        <span style={{ fontSize: "0.84rem", fontWeight: 800, color: "#0f172a" }}>Instagram</span>
                                        <span style={{ fontSize: "0.74rem", color: "#475569" }}>Follow us for photos and updates.</span>
                                    </span>
                                    <span aria-hidden="true" style={{ color: "#94a3b8", fontSize: "0.9rem" }}>↗</span>
                                </a>
                                ...
                                <a
                                    ...
                                    style={{
                                        ...
                                        background: "linear-gradient(180deg, rgba(254,242,242,0.98), rgba(255,247,247,0.96))",
                                    }}
                                >
                                    <span aria-hidden="true" style={{ color: "#dc2626", display: "inline-flex", alignItems: "center", justifyContent: "center" }}>
                                    ...
                                    <span style={{ display: "grid", gap: "2px", minWidth: 0 }}>
                                        <span style={{ fontSize: "0.84rem", fontWeight: 800, color: "#0f172a" }}>YouTube</span>
                                        <span style={{ fontSize: "0.74rem", color: "#475569" }}>Watch cleanup videos and shorts.</span>
                                    </span>
                                    <span aria-hidden="true" style={{ color: "#94a3b8", fontSize: "0.9rem" }}>↗</span>
                                </a>
                    ...
                    >
                        ...
                        <a
                            ...
                            style={{
                                ...
                                background: "linear-gradient(135deg, #ff4343 0%, #ff0000 60%, #d80000 100%)",
                                color: "#fff",
                                padding: "0 11px",
                                textDecoration: "none",
                            }}
...
function App() {
    ...
    const getItemStory = (item) => {
        ...
        const fromDbReferenceImageCaption =
            dbStoryFieldSupport.referenceImageCaption !== false && typeof item.reference_image_caption === "string"
                ...
                : "";
        const fromDbFacebookVideoUrl =
            dbStoryFieldSupport.facebookVideoUrl !== false && typeof item.facebook_video_url === "string"
                ? item.facebook_video_url.trim()
                : "";
        const fromDbInstagramVideoUrl =
            dbStoryFieldSupport.instagramVideoUrl !== false && typeof item.instagram_video_url === "string"
                ? item.instagram_video_url.trim()
                : "";
        const fromDbYoutubeVideoUrl =
            dbStoryFieldSupport.youtubeVideoUrl !== false && typeof item.youtube_video_url === "string"
        ...
        if (
            ...
            fromDbFacebookVideoUrl ||
            fromDbInstagramVideoUrl ||
            fromDbYoutubeVideoUrl
        ) {
            return {
                ...
                facebookVideoUrl: fromDbFacebookVideoUrl,
                instagramVideoUrl: fromDbInstagramVideoUrl,
                youtubeVideoUrl: fromDbYoutubeVideoUrl,
            };
        }
        ...
        return {
            ...
            facebookVideoUrl: typeof fromLocal.facebookVideoUrl === "string" ? fromLocal.facebookVideoUrl.trim() : "",
            instagramVideoUrl: typeof fromLocal.instagramVideoUrl === "string" ? fromLocal.instagramVideoUrl.trim() : "",
            youtubeVideoUrl: typeof fromLocal.youtubeVideoUrl === "string" ? fromLocal.youtubeVideoUrl.trim() : "",
        };
    };
    ...
    function startEditingItem(item) {
        ...
        setEditForm({
            ...
            facebookVideoUrl: story?.facebookVideoUrl || "",
            instagramVideoUrl: story?.instagramVideoUrl || "",
            youtubeVideoUrl: story?.youtubeVideoUrl || "",
        });
    }
    ...
    async function saveItemEdits(itemId) {
        ...
        const facebookVideoUrl = (editForm.facebookVideoUrl || "").trim();
        const instagramVideoUrl = (editForm.instagramVideoUrl || "").trim();
        const youtubeVideoUrl = (editForm.youtubeVideoUrl || "").trim();
        ...
        if (dbStoryFieldSupport.facebookVideoUrl !== false) updatePayload.facebook_video_url = facebookVideoUrl || null;
        if (dbStoryFieldSupport.instagramVideoUrl !== false) updatePayload.instagram_video_url = instagramVideoUrl || null;
        if (dbStoryFieldSupport.youtubeVideoUrl !== false) updatePayload.youtube_video_url = youtubeVideoUrl || null;
